...
public class Get11 extends GoRestBaseUrl {
    ...
    public void get11(){
        ...
        //1. Set The URL
        specGoRest.pathParam("first", "users");

        // 2. Set The Expected Data ( put, post, patch)

        // 3. Send The Request And Get The Response
        Response response = given().spec(specGoRest).when().get("/{first}");
        ...
        response.
                ...
                body("meta.pagination.limit",equalTo(10),
                        ...
                        "data.name", hasItems("Govinda Khatri", "Vishwamitra Dubashi", "Gov. Shrishti Mahajan"));
        ...
        assertTrue(numOfmale<=genders.size()-numOfmale);
